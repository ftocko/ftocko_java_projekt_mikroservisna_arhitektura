package org.foi.nwtis.ftocko.aplikacija_5.wsock;
...
public class Info {
	 ...
	 * @return vraća poruku
	 */
	private String vratiPoruku(String icaoDodanogAerodroma) {

		SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");
		Date datum = new Date();
		String pDatum = sdf.format(datum);
		
		return pDatum + ", "+icaoDodanogAerodroma;
	}
	 ...
	 */
	@OnMessage
	public void stiglaPoruka(Session sesija, String porukaIcao) {
		System.out.println("Sesija: " + sesija.getId() + ", poruka: " + porukaIcao);

		posalji(vratiPoruku(porukaIcao));
	}
